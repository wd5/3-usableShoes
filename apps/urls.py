...
urlpatterns = patterns('',
    ...
    url(r'^catalog/category/(?P<slug>[^/]+)/(?P<s_type>[^/]+)/$',show_category, name='show_category_by_type'),
    url(r'^catalog/category/(?P<slug>[^/]+)/(?P<s_type>[^/]+)/(?P<pk>[^/]+)/$',show_product, name='show_product'),
    ...
    (r'^change_size_cart_product/$','apps.orders.views.change_size_cart_product'),
